...
public class Day_18 {
    ...
    private static final String INPUT_TEST = Resources.getResourceAsString("aoc2023/18-test.txt");
    private static final String INPUT = Resources.getResourceAsString("aoc2023/18-main.txt");
    ...
    private static long countNonEmpty(char[][] field) {
    ...
    public static void main(String[] args) {
        ...
        //long result1Old = countNonEmpty(field);
