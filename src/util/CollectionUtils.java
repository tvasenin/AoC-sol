...
public class CollectionUtils {
    ...
    public static MutableIntList parseToMutableIntList(String input, String delimiterPattern) {
        return Helpers.getTokens(input, delimiterPattern).collect(Collectors2.collectInt(Integer::parseInt, IntLists.mutable::empty));
    }

    public static MutableIntSet parseToMutableIntSet(String input, String delimiterPattern) {
        return Helpers.getTokens(input, delimiterPattern).collect(Collectors2.collectInt(Integer::parseInt, IntSets.mutable::empty));
    }
